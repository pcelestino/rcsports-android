 ...
 */
public class ClientExclusionDialogFragment extends DialogFragment implements IOnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sales = DAO.open(getActivity()).findSalesWithClientId(clientId);
        ...
        if (listSaleExclusion.getCount() <= 0) {
            getDialog().setTitle("Excluir cliente " + DAO.open(getActivity()).findClientById(clientId).getName());
        }
        ...
        btExcludes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DAO.open(getActivity()).delete(client);
                ...
                callback.onCLickDelete(getArguments().getInt("client_position"));
